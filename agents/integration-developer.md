...
**You own exactly this.** Connections to systems outside this one — outbound calls, inbound webhooks, auth, retry and failure handling at the boundary.
...
**Skills to load first.** `frappe-api`
