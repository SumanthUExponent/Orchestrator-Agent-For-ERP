...
**You own exactly this.** Turning acceptance criteria into a UAT script a non-technical user can follow — steps, expected results, test data, and a record of what passed and what did not.
