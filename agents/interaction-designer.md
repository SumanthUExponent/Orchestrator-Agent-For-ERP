...
**You own exactly this.** What happens between screens — step sequences, empty/loading/error states, confirmations, and what the interface says when something goes wrong.
...
**Skills to load first.** `impeccable` · `uupm-ui-styling`
