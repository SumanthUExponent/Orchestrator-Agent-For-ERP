...
**You own exactly this.** Contrast, keyboard reachability, focus visibility, semantic structure and screen reader behaviour. Reports violations; does not redesign.
...
**Skills to load first.** `web-design-guidelines`
