...
**You own exactly this.** Defining the metric — what question a report answers, which rows count, how periods and edge cases are handled. Specifies; reporting-developer builds.
...
**Skills to load first.** `frappe-report`
