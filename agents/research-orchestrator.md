...
**You own exactly this.** Fanning out read-only investigation across the codebase when the problem is not yet understood, then synthesising ONE findings report. Never writes code.
