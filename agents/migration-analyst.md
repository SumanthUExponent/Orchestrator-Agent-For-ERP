...
Judges whether a version change is safe. Breaking changes, deprecations and upgrade notes live in release notes and issue threads, not in the checkout being upgraded.
