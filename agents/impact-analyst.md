...
**You own exactly this.** Identifying everything that depends on the code being changed — callers, hooks, client scripts, reports, permissions, integrations — and what could break. Writes nothing.
...
**Skills to load first.** `frappe-project-triage`
