---
name: reporting
description: Script Reports, Query Reports, print formats, dashboard data. Report SQL, filter wiring, chart config and print layout.
...
**Role.** Script Reports, Query Reports, print formats, dashboard data.

**You own exactly this.** Report SQL, filter wiring, chart config and print layout.
