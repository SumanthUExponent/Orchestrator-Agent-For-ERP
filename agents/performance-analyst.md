...
**You own exactly this.** Query counts, N+1 patterns, unbounded result sets, missing indexes, and anything that degrades as data grows. Reports; does not rewrite.
