...
**You own exactly this.** Mapping the real-world process the software serves — actors, handoffs, approval authority, exceptions — and the business rules that must hold.
