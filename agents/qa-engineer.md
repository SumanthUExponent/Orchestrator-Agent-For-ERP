...
**You own exactly this.** Finding what automated tests miss — walking the real journey, the unhappy paths, permissions as a different role, and boundaries nobody specified.
