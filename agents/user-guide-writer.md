...
**You own exactly this.** End-user guides written from the user's side of the screen, with every state, button and validation rule traced back to source rather than assumed.
...
**Skills to load first.** `gdoc-user-guide`
